...
class FocalLoss_TMG(nn.Module):
    def __init__(self, alpha=0.25, gamma=2, num_classes=2, size_average=True):
        super(FocalLoss_TMG, self).__init__()
        ...
        if isinstance(alpha, list):
            ...
            alpha_tensor[0] += alpha
            alpha_tensor[1:] += (1 - alpha)
    ...
    def forward(self, preds, labels):
        ...
        print(preds_logsoft.shape, labels.shape)
...
class BertForTokenClassification(BertPreTrainedModel):
    ...
    def __init__(self, config, label_smoothing=0.0):
        ...
        self.init_weights()
        self.FocalLoss_TMG = FocalLoss_TMG(alpha=0.25,gamma=2.0)
    ...
    def forward(
        ...
        if labels is not None:
            ...
            if attention_mask is not None:
                ...
                # print("1",loss)
                # loss_F = self.FocalLoss_TMG(active_logits, active_labels)
                # print("2",loss_F)


            else:
                loss = loss_fct(logits.view(-1, self.num_labels), labels.view(-1))
                # loss_F = FocalLoss_BIC(alpha=0.25,gamma=2.0)(active_logits, active_labels)
