from transformers import BertTokenizer, RobertaTokenizer, XLMRobertaTokenizer, AutoTokenizer, BertTokenizerFast
...
def build_tokenizer(text_encoder: str, dropout=0):
    ...
    if ('bert-base-uncased' in text_encoder) or ('bert-large-uncased' in text_encoder) :
        if dropout > 0:
            ...
            tokenizer = BertTokenizerFast.from_pretrained(text_encoder, local_files_only=True)
